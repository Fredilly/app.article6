...
Status is sourced from `docs/roadmaps/agentic-verification/phase-status.json`; this lane is frozen for now. It remains a future option and is not part of the active customer-validation roadmap.
