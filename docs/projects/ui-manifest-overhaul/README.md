...
- Trust is always visible: provenance + audit hashes + source SHA.
- Every claim is clickable back to evidence.
- Mobile-first: two-panel desktop, bottom sheet mobile.
- Modular PRs, Vercel stays green.
