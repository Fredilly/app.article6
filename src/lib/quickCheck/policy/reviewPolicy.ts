...
const REVIEW_POLICY_CONFIG_RAW = {
  ...
  reviewAreas: {
    additionality: {
      ...
      preferredSections: [
        { sectionNumber: "B.3", titleIncludes: "additionality", score: 20 },
        { sectionNumber: "B.3", titleIncludes: "demonstration of additionality", score: 22 },
        { sectionNumber: "B.3", titleIncludes: "additionality tool", score: 20 },
        { sectionNumber: "3.3", titleIncludes: "additionality", score: 18 },
        { sectionNumber: "3.3", titleIncludes: "demonstration of additionality", score: 20 },
      ],
      evidenceSignals: ["demonstration of additionality", "additionality tool", "investment analysis"],
    },
    baseline: {
      baseKeywords: [
        "baseline",
      ...
      preferredSections: [
        { sectionNumber: "B.2", titleIncludes: "baseline scenario", score: 20 },
        { sectionNumber: "B.3", titleIncludes: "baseline scenario", score: 20 },
        { sectionNumber: "B.4", titleIncludes: "baseline", score: 18 },
        { sectionNumber: "B.5", titleIncludes: "baseline", score: 18 },
        { sectionNumber: "B.2", titleIncludes: "identification of baseline", score: 22 },
        { sectionNumber: "B.3", titleIncludes: "alternatives analysis", score: 20 },
        { sectionNumber: "2.4", titleIncludes: "baseline scenario", score: 16 },
        { sectionNumber: "2.5", titleIncludes: "baseline", score: 14 },
      ],
      evidenceSignals: ["baseline scenario", "identification of baseline", "alternatives analysis"],
    },
    boundary: {
    ...
    leakage: {
      ...
      preferredSections: [
        { sectionNumber: "E.1.2.2", titleIncludes: "leakage", score: 20 },
        { sectionNumber: "E.1.2.2", titleIncludes: "leakage emissions", score: 22 },
        { sectionNumber: "3.3", titleIncludes: "leakage", score: 16 },
        { sectionNumber: "3.3", titleIncludes: "estimated leakage", score: 18 },
      ],
      titlePenalties: [
        {
          titleIncludes: "grid emission factor",
          score: 10,
        },
      ],
    },
