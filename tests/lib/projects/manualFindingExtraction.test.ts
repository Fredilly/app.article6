...
describe('manual finding extraction', () => {
  ...
  it('extracts F-001 style findings from table sections and marks uncertain types as needs review', () => {
    const result = extractManualFindingDraftsFromPages({
      pages: [
        {
          pageNumber: 142,
  ...
  it('maps generic finding ids to CAR when nearby labels make the type clear', () => {
    const result = extractManualFindingDraftsFromPages({
      pages: [
        {
          pageNumber: 150,
