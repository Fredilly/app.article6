...
- document family: Project Description / PD
- registry: VCS with CCB
- PDF project title: Maya Forest Corridor REDD Project
- fixture title: Maya Forest Corridor REDD Belize
- project ID: 5294
- host country: Belize
- crediting period: 1 January 2022 - 31 December 2041
- monitoring plan: present in section 3.3.3; monitoring is carried out over 40 years, with tasks before each verification event at a maximum interval of 5 years
- reporting period: not applicable in this intake fixture because this is a project description, not a monitoring or verification report

## Methodology version

- raw PDF quote: `Methodology VM0007 VM0007 REDD+ Methodology Framework (REDD+MF) 1.8`
- normalized methodology version value: `v1.8`
...
- reviewed gold answer: Belize
- reviewed gold quote: Project location Belize, Belize and Cayo Districts
- reviewed expected status: FOUND
- weak evidence to reject: district names inside addresses are not the host country answer
...
- reviewed gold answer: VM0007 REDD+ Methodology Framework v1.8
- reviewed gold quote: Methodology VM0007 VM0007 REDD+ Methodology Framework (REDD+MF) 1.8
- reviewed expected status: FOUND
- weak evidence to reject: the long methodology/module/tool table must not become the visible answer dump
...
- source type: exact_section
- reviewed gold answer: REDD project area consists of sanctioned deforestation caused by conversion to industrial agriculture
- reviewed gold quote: REDD project area consists of sanctioned deforestation caused by conversion to industrial agriculture.
- reviewed expected status: FOUND
- weak evidence to reject: the section 2.2.2 narrative is related background, but the formal baseline section is the cleaner reviewed truth source
...
- source type: exact_section
- reviewed gold answer: Leakage is assessed under VMD0009 LK-ASP using Approach 2 Market Leakage Assessment; sugarcane is the likely baseline commodity; timber leakage is excluded as de minimis.
- reviewed gold quote: Leakage was determined following the steps described in module VMD0009 Estimation of emissions from activity shifting for avoiding planned deforestation/forest degradation and avoiding planned wetland degradation (LK-ASP). Since a specific agent of deforestation is not identified, a class of deforestation is used to determine activity shifting leakage using approach 2 Market Leakage Assessment. As described in section 3.1.3, given the fact that harvested wood products are identified as de minimis, market effects leakage due to decreased timber harvest was excluded from the analysis. The most likely commodity for the class of deforestation agent is Sugarcane (Saccharum officinarum).
- reviewed expected status: FOUND
- weak evidence to reject: page 82 “Not applicable. Refer to 3.2.3 Leakage Emissions” must not satisfy leakage by itself
- additional note: page 122 later states LKMAF = 1, but that is secondary support rather than the primary visible answer
...
All six generated draft checks disagreed with reviewed PDF truth.
